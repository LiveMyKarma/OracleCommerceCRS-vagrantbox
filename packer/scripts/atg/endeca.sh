...
sudo -u atgdev /vagrant/atg_installer/endeca/OCplatformservices11.1.0-Linux64.bin --silent --target /home/atgdev/commerce/ < /vagrant/packer/scripts/atg/platformsilent.txt
...
sudo cp /vagrant/packer/scripts/atg/workbench-init.d.sh /etc/init.d/workbench
